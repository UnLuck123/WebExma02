	...
	function adressValidation(adress,detailadress){
		if(checkchar(adress) && checkchar(detailadress)){
			return true;
		}
		else{
	...
	function validateForm() {
    	...
    	var id = document.accounteditform.id.value;
    	var chkid = document.accounteditform.chkid.value;
    	var pwd = document.accounteditform.pwd.value;    	
    	var chkpwd = document.accounteditform.chkpwd.value;
    	var name = document.accounteditform.name.value;
    	var gender = document.accounteditform.gender.value;
    	var Frnn = document.accounteditform.Frnn.value;
    	var Srnn = document.accounteditform.Srnn.value;
    	var email1 = document.accounteditform.email1.value;
    	var email2 = document.accounteditform.email2.value;
    	var postcode = document.accounteditform.postcode.value;
    	var adress = document.accounteditform.adress.value;
    	var detailadress = document.accounteditform.detailadress.value;
